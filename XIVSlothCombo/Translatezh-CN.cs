...
public class Translatezh_CN
{
    ...
    public static Dictionary<string, string> db = new()
    {
        ...
        {"Makes the AOE combos unusable if not in melee range of target.","敌人不在近战范围时不可使用AOE combo"},
        #endregion
        #endregion
        #region BLACK MAGE
        ...
        {"Advanced Summoner Feature","等待翻译"},
        ...
        {"Demi Attacks Combo Option","等待翻译"},
        {"Adds Deathflare, Ahk Morn and Revelation to the single target and AoE combos.","等待翻译"},
        {"Egi Attacks Combo Option","等待翻译"},
        {"Adds Gemshine and Precious Brilliance to the single target and AoE combos, respectively.","等待翻译"},
        {"Garuda Slipstream Option","等待翻译"},
        {"Adds Slipstream to the single target and AoE combos.","等待翻译"},
        {"Ifrit Cyclone Option","等待翻译"},
        {"Adds Crimson Cyclone and Crimson Strike to the single target and AoE combos.","等待翻译"},
        {"Titan Mountain Buster Option","等待翻译"},
        {"Adds Mountain Buster to the single target and AoE combos.","等待翻译"},
        ...
        {"Use Divine Benison on oGCD Option","只在能力技特性上使用神祝祷"},
        {"Only shows Divine Benison during oGCD weave window when target is not already under the effect.","目标没有神祝祷时，在能力技窗口时，显示神祝祷"},
        {"Use Divine Benison on GCD Option","在 GCD 选项上使用神祝祷"},
        {"Shows Divine Benison when target is not already under the effect.","目标身上没有神祝祷时，显示神祝祷"},
        {"Prioritize oGCDs Option","优先考虑能力技"},
        {"Displays oGCD Heals/Shields over Afflatus","显示能力技奶和减伤到安慰之心/狂喜之心"},
        {"Replaces Medica II with Medica whenever you are under Medica II's regen.","等待翻译"},
        {"Afflatus Rapture on Medica Option","狂喜之心-医济"},
        {"Adds Afflatus Rapture to the Medica Feature when available.","狂喜之心添加到医济选项"},
        {"Afflatus Misery on Medica Option","苦难之心-医济"},
        {"Adds Afflatus Misery to the Medica Feature when Misery is ready to be used.","当苦难之心可用时，添加到医济选项"},
        {"Thin Air on Medica Option","无中生有-医济"},
        {"Adds Thin Air to the Medica Feature when available.","把无中生有用于医济选项"},
        {"Cure II Sync Feature","救疗特性"},
        {"Changes Cure II to Cure when synced below Lv.30.","低于30级时用治疗替换救疗"},
        {"Changes Swiftcast to Raise.","即刻后替换为复活"},
        {"Adds Thin Air to the Global Raise Feature/Alternative Raise Feature.","添加无中生有到全局复活/替换复活功能"},
        {"Meisui Feature","命水特性"},
        {"Uses Three Mudra on Meisui when HP under a certain threshold.","你的HP低于设定值时，使用三印自在+命水"},
        {"Adds Curing Waltz to the combo when available, and your HP is at or below the set percentage.","你的HP等于或低于设定百分比时把治疗华尔兹加入到combo中"},
        {"Makes the AoE combos unusable if not in melee range of target.","不在近战范围内时，不可使用aoe combo"},
        {"Pools stacks of Immortal Sacrifice before using Plentiful Harvest.\nAlso holds Plentiful Harvest if Death Warrant is on cooldown.\nSet the value to 3 or below to use Plentiful as soon as it's available.","等待翻译"},
        {"Turns Ruin III into an all-in-one damage button.\nOnly uses Crimson Cyclone when in melee range.","把毁荡变成伤害combo按钮。\n仅在近战范围内使用深红旋风"},
        {"Radiant Aegis Option","守护之光选项"},
        {"Adds Radiant Aegis to the combo when available, and your HP is at or below the set percentage.","血量低于设定百分比时，把守护之光加入到combo中"}
    };
}
